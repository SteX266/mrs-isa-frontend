...
<form>
  <div className="mb-6">
    ...
    <div id="emailHelp" className="form-text">Your email address will not be shared with anyone.</div>
  ...
  <div className="mb-6">
    <label htmlFor="exampleInputPassword1" className="form-label">Repeat passwrod</label>
    <input name="repeatedPassword" onChange={handleChange} type="password" className="form-control" id="exampleInputPassword1"/>
    {errors.repeatedPassword.length > 0 && <span className='error'>{errors.repeatedPassword}</span>}
  </div>
  <div className="mb-6">
    <label htmlFor="exampleInputEmail1" className="form-label">Name</label>
    <input name="name" onChange={handleChange} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>
    {errors.name.length > 0 && <span className='error'>{errors.name}</span>}
  </div>
  <div className="mb-6">
    <label htmlFor="exampleInputEmail1" className="form-label">Surname</label>
    <input name="surname" onChange={handleChange} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>
    {errors.surname.length > 0 && <span className='error'>{errors.surname}</span>}
  </div>
  <div className="mb-6">
    <label htmlFor="exampleInputEmail1" className="form-label">Home address</label>
    <input name="addressLine" onChange={handleChange} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>
    {errors.addressLine.length > 0 && <span className='error'>{errors.addressLine}</span>}
  </div>
  <div className="mb-6">
    <label htmlFor="exampleInputEmail1" className="form-label">Phone number</label>
    <input name="phoneNumber" onChange={handleChange} type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>
